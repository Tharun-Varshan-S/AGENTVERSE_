...
import CivicIssueGuide from '../components/CivicIssueGuide';
...
const ReportComplaint = () => {
  ...
  const handleSelectCategory = (category) => {
    setPrefilledDescription(category.sampleText);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      ...
      {/* Main Grid Layout: Left = Form / Confirmation, Right = Civic Issue Guide */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        
        {/* Left Section (Form or Confirmation) */}
        ...
        {/* Right Section (Civic Issue Reference Card) */}
        <div className="lg:col-span-6 xl:col-span-6 w-full">
          <CivicIssueGuide onSelectCategory={handleSelectCategory} />
        </div>
